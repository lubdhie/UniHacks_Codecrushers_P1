    ...
    return (
        <div className="post-card-item">
            <div className="post-header-row">
                <img
                    src={post.author?.profile_picture || `https://ui-avatars.com/api/?name=${post.name || 'User'}&background=random`}
                    alt="Author"
            ...
            <div className="post-body-content">
                ...
                {post.image && (
                    <div className="post-image-container">
                        <img src={post.image} alt="Post Attachment" className="post-inline-image" />
                    </div>
                )}
            </div>
